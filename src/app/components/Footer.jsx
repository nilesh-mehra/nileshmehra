      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex space-x-4">
            ...
            <a href="https://github.com/nilesh-mehra" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
            ...
            <a href="https://www.linkedin.com/in/nilesh-mehra-99692b387" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
